class Turret extends Entity {
    ...
    fire() {
        ...
        new EasingProjectile(this.game, this.x, this.y, dir1, this.pSpeed, this.pLifeTime, true, this, this.projectileAnimation, 1, 1, 10, this.pMove, this.pEasing);
        if (this.cross) {
            let dir2 = {
            ...
            new EasingProjectile(this.game, this.x, this.y, dir2, this.pSpeed, this.pLifeTime, true, this, this.projectileAnimation, 1, 1, 10, this.pMove, this.pEasing);
            new EasingProjectile(this.game, this.x, this.y, dir3, this.pSpeed, this.pLifeTime, true, this, this.projectileAnimation, 1, 1, 10, this.pMove, this.pEasing);
            new EasingProjectile(this.game, this.x, this.y, dir4, this.pSpeed, this.pLifeTime, true, this, this.projectileAnimation, 1, 1, 10, this.pMove, this.pEasing);
        }
    }
}
