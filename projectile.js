...
function Projectile(game, x, y, dir, speed, lifetime)
{
	...
	var lightningBalls = [];
	lightningBalls.push(new Animation(game.AM.getAsset("./img/projectiles/BallPulseBlue.png"), 32, 32, {x: 0, y: 0}, {x: 3, y: 0}, 10, true, 5));
	lightningBalls.push(new Animation(game.AM.getAsset("./img/projectiles/BallPulseRed.png"), 32, 32, {x: 0, y: 0}, {x: 3, y: 0}, 10, true, 5));
	lightningBalls.push(new Animation(game.AM.getAsset("./img/projectiles/BallPulseGreen.png"), 32, 32, {x: 0, y: 0}, {x: 3, y: 0}, 10, true, 5));
	...
	this.game.addTimer(new TimerCallBack(this.game, lifetime, false, function () {this.destroy();}));
}
